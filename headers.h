...
static int list_drives(const bool, char [][STRING_SIZE]);
static char *selectBootDrive(void);
static void update_bootdev(void);
static void setup_print_drives(const int, const int, const char[][STRING_SIZE]);
static void boot_setup(char [][STRING_SIZE], const int);
int get_currentTimezone(void);
time_t get_currentTimeZone_offset(void);
static void timezones_init(void);
static void update_timezone(void);
static void setup_print_timezones(void);
static void timezone_setup(void);
...
bool isSystemOn(void);
static inline void clock_pulse(void);
static void input_delay_handler(void);
static unsigned long fetch(void);
void makeRegisterPointers(const int, registerP_t *);
static void error_def(void);
static void const_def(void);
static void print_error(registerP_t *);
void loadToMemory(FILE *, char *);
static void unloadFromMemory(void);
static void proc_init(void);
static void goto_point_init(void);
static int findProc(const char *);
static int findGotoPoint(const char *);
...
void hashRegisters(const int, char [][STRING_SIZE], registerP_t *);
...
void switch_strings(char *, char *);
void shift_strings(char [][STRING_SIZE], int, int, int);
int getchar_fixed(void);
void intPtoString(char *, long long int *, const bool, const int);
void pause_program(void);
bool memAddress_check(const int);
void memoryInit(int);
void flushMemoryAddress(const int, const int);
...
void F_XOR(long long *, long long *, long long *);
void F_NAND(long long *, long long *, long long *);
void F_NOR(long long *, long long *, long long *);
void F_ADD(long long *, long long *, long long *);
void F_SUB(long long *, long long *, long long *);
void F_DIV(long long *, long long *, long long *);
void F_MUL(long long *, long long *, long long *);
void F_LO(long long *, long long *, long long *);
void F_INC(long long *);
void F_DEC(long long *);
void F_NEG(long long *);
void F_EQ(long long *, long long *, long long *);
void F_HIGHER(long long *, long long *, long long *);
void F_LOWER(long long *, long long *, long long *);
void F_SHIFTFORWARD(long long *, long long *, long long *);
void F_SHIFTBACK(long long *, long long *, long long *);
void F_BITAND(long long *, long long *, long long *);
void F_BITOR(long long *, long long *, long long *);
FILE *drive_init(const char *);
void drive_uninit(FILE *);
void sector_init(const int, const int, const int);
void metadata_init(FILE *);
long sectorSearch(void);
int metadataMemorySearch(void);
...
void writeChar(const char *, const char, const int, FILE *);
void metadataMemoryInit(void);
disk_info_t get_disk_info(const char *);
void getFileInfo(long long int *dest, const int n, const int maxlen);
int midiToFreq(unsigned char);
